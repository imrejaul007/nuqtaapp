...
/**
 * SALON & SPA MERCHANT PITCH DECK
 * Niche-specific version of Engine A for salons, spas, and beauty businesses
 *
 * Key customizations:
 * - Beauty/wellness specific language and examples
 * - Salon-specific objections and benefits
 * - Typical salon/spa metrics (higher margins, appointment-based)
 *
        ...
        return (
          <div className={`${slideClass} w-full min-h-screen bg-gradient-to-br from-[#0a1628] via-[#1a2638] to-[#0a1628] flex items-center justify-center p-4 sm:p-6 md:p-12 relative overflow-hidden`}>
            <div className="absolute inset-0">
              ...
              <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-pink-500 rounded-full blur-[120px] opacity-15" />
            </div>

            <div className="relative z-10 max-w-5xl w-full text-center px-2">
              {/* Badge */}
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#c9a227]/20 to-pink-500/20 border border-[#c9a227]/30 rounded-full mb-6 animate-[fadeIn_1s_ease-out]">
                <Scissors className="w-4 h-4 text-[#c9a227]" />
                <span className="text-[#c9a227] font-semibold text-sm">For Salons & Spas</span>
              </div>
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-white leading-tight mb-6 animate-[slideDown_0.8s_ease-out]">
                ...
                <span className="bg-gradient-to-r from-[#c9a227] to-pink-400 bg-clip-text text-transparent">Loyal Regulars</span>
              </h1>
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-slate-400 mb-8 max-w-3xl mx-auto animate-[fadeIn_1s_ease-out_0.3s] opacity-0 [animation-fill-mode:forwards]">
                Get clients rebooking 2.5x more often. Pay only when they visit.
              </p>
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-10 animate-[fadeIn_1s_ease-out_0.5s] opacity-0 [animation-fill-mode:forwards]">
                {[
                  ...
                  { value: '2.5x', label: 'More Rebookings' },
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-[slideUp_0.8s_ease-out_0.7s] opacity-0 [animation-fill-mode:forwards]">
                <button
                  ...
                  className="px-8 py-4 bg-gradient-to-r from-[#c9a227] to-pink-500 text-[#0a1628] font-bold rounded-full text-lg flex items-center gap-2 hover:shadow-[0_0_30px_rgba(201,162,39,0.4)] transition-all"
                >
                  <Play size={20} />
                  See How It Works
                </button>
            ...
            <div className="relative z-10 max-w-6xl w-full px-2">
              <div className="text-center mb-8 sm:mb-10 animate-[slideDown_0.8s_ease-out]">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-red-500/20 border border-red-500/30 rounded-full mb-4">
                  ...
                  <span className="text-red-400 font-semibold text-sm">The Beauty Challenge</span>
                </div>
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white leading-tight">
                  Great Service, <span className="text-red-400">No Rebookings</span>
                </h1>
              </div>
                ...
                {[
                  {
                    stat: '60%',
                    label: 'Don\'t Rebook',
                    desc: 'Most clients visit once and go elsewhere. Even if they loved the service.',
                    icon: Users
                  },
                  {
                    stat: 'AED 40K+',
                    label: 'Marketing Waste',
                    desc: 'Instagram ads, influencers - they bring new clients but not loyalty.',
                    icon: DollarSign
                  },
                  {
                    stat: '0',
                    label: 'Client Insights',
                    desc: 'Who are your best clients? What services do they prefer? You don\'t know.',
                    icon: BarChart3
                  }
                ].map((item, idx) => (
              ...
              <div className="mt-8 animate-[slideUp_0.8s_ease-out_0.4s] opacity-0 [animation-fill-mode:forwards]">
                <div className="bg-gradient-to-r from-red-500/10 to-pink-500/10 backdrop-blur-xl border border-red-500/20 rounded-2xl p-6 text-center">
                  <p className="text-white text-lg font-semibold">
                    You need a way to <span className="text-red-400 font-bold">turn every client into a regular</span> - automatically.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className={`${slideClass} w-full min-h-screen bg-gradient-to-br from-[#0a1628] via-[#1a2638] to-[#0a1628] flex items-center justify-center p-4 sm:p-6 md:p-12 relative overflow-hidden`}>
            ...
            <div className="relative z-10 max-w-6xl w-full px-2">
              <div className="text-center mb-8 animate-[slideDown_0.8s_ease-out]">
                ...
                <p className="text-lg sm:text-xl text-slate-400 mt-4">Every appointment becomes a reason to rebook</p>
              </div>

              {/* How it works */}
              <div className="relative mb-8 animate-[fadeIn_0.8s_ease-out_0.2s] opacity-0 [animation-fill-mode:forwards]">
                <div className="absolute inset-0 bg-gradient-to-r from-[#c9a227]/10 to-pink-500/10 rounded-3xl blur-xl" />
                <div className="relative bg-white/5 backdrop-blur-xl border-2 border-[#c9a227]/30 rounded-3xl p-6 sm:p-8">
                  <h3 className="text-[#c9a227] font-bold text-center mb-6 text-xl">Client Journey</h3>
                  <div className="flex flex-col md:flex-row items-center justify-center gap-4 text-center">
                    <div className="px-5 py-4 bg-white/5 rounded-xl border border-white/10 flex-1 max-w-[200px]">
                      <Scissors className="w-8 h-8 text-pink-400 mx-auto mb-2" />
                      <p className="text-white font-bold">Client Pays</p>
                      <p className="text-slate-400 text-sm">AED 200 haircut</p>
                    </div>
                    ...
                    <div className="px-5 py-4 bg-white/5 rounded-xl border border-white/10 flex-1 max-w-[200px]">
                      ...
                      <p className="text-white font-bold">Gets AED 20 Coins</p>
                    ...
                    <div className="px-5 py-4 bg-[#c9a227]/20 rounded-xl border-2 border-[#c9a227] flex-1 max-w-[200px]">
                      ...
                      <p className="text-[#c9a227] font-bold">Rebooks!</p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 animate-[slideUp_0.8s_ease-out_0.4s] opacity-0 [animation-fill-mode:forwards]">
                {[
                  { icon: Target, title: '2.5x More Rebookings', desc: 'Clients come back to spend their coins' },
                  { icon: BarChart3, title: 'Know Your Clients', desc: 'See preferences, visit frequency, spending patterns' },
                  { icon: Shield, title: 'No System Changes', desc: 'Keep your existing booking system. Zero changes.' }
                ].map((item, idx) => (
            ...
            <div className="relative z-10 max-w-6xl w-full px-2">
              <div className="text-center mb-8 animate-[slideDown_0.8s_ease-out]">
                ...
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-white leading-tight">
                  Example: <span className="text-emerald-400">Your Salon</span>
                </h1>
              </div>
              ...
              <div className="relative mb-8 animate-[fadeIn_0.8s_ease-out_0.2s] opacity-0 [animation-fill-mode:forwards]">
                ...
                <div className="relative bg-white/5 backdrop-blur-xl border-2 border-emerald-500/30 rounded-3xl p-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    {[
                      { label: 'Avg Service', value: 'AED 180' },
                      { label: 'Nuqta Clients/Month', value: '80' },
                      { label: 'Repeat Rate', value: '2.5x' },
                      { label: 'Your Margin', value: '70%' }
                    ].map((item, idx) => (
                  ...
                  <div className="bg-black/30 rounded-2xl p-5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
                      <div className="p-4 bg-white/5 rounded-xl">
                        ...
                        <p className="text-2xl font-black text-emerald-400">AED 36,000</p>
                        <p className="text-slate-500 text-xs">80 × AED 180 × 2.5 visits</p>
                      </div>
                      <div className="p-4 bg-white/5 rounded-xl">
                        <p className="text-slate-400 text-sm mb-1">Your Nuqta Cost</p>
                        <p className="text-2xl font-black text-white">AED 5,760</p>
                      ...
                      <div className="p-4 bg-[#c9a227]/20 rounded-xl border border-[#c9a227]/30">
                        ...
                        <p className="text-2xl font-black text-[#c9a227]">AED 19,440</p>
                        <p className="text-slate-500 text-xs">70% margin - 16% cost = 54% net</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="animate-[slideUp_0.8s_ease-out_0.4s] opacity-0 [animation-fill-mode:forwards]">
                <div className="bg-[#c9a227]/10 border border-[#c9a227]/30 rounded-2xl p-4 text-center">
                  <p className="text-white font-semibold">
                    <span className="text-emerald-400 font-black">AED 19,440 extra profit/month</span> from clients who would have visited once and never returned.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative z-10 max-w-5xl w-full px-2">
              ...
              <div className="mb-8 animate-[fadeIn_0.8s_ease-out_0.2s] opacity-0 [animation-fill-mode:forwards]">
                <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
                  <p className="text-[#c9a227] font-bold text-center mb-6">Per AED 100 Service</p>
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center mb-4">
                    <div className="p-4 bg-emerald-500/10 rounded-xl border border-emerald-500/20">
                      ...
                      <p className="text-slate-400 text-sm">Cashback to Client</p>
                  ...
                  <p className="text-slate-400 text-center text-sm">With 70%+ salon margins, you still make 54%+ profit on every Nuqta service</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 animate-[slideUp_0.8s_ease-out_0.4s] opacity-0 [animation-fill-mode:forwards]">
                <div className="bg-red-500/10 border border-red-500/30 rounded-2xl p-5">
                  ...
                  <ul className="space-y-2 text-slate-400 text-sm">
                    <li>• Client visits once, pays AED 200</li>
                    <li>• You make AED 140 profit</li>
                    <li>• They try a different salon next time</li>
                    <li>• <span className="text-red-400 font-bold">Total: AED 140</span></li>
                  </ul>
                </div>
                <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-2xl p-5">
                  <p className="text-emerald-400 font-bold mb-3">With Nuqta</p>
                  <ul className="space-y-2 text-slate-400 text-sm">
                    <li>• Client visits 2.5x, pays AED 500 total</li>
                    <li>• You pay AED 80 total cost (16%)</li>
                    <li>• They become a loyal regular</li>
                    <li>• <span className="text-emerald-400 font-bold">Total: AED 270 profit</span></li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className={`${slideClass} w-full min-h-screen bg-gradient-to-br from-[#0a1628] via-[#1a2638] to-[#0a1628] flex items-center justify-center p-4 sm:p-6 md:p-12 relative overflow-hidden`}>
            ...
            <div className="relative z-10 max-w-6xl w-full px-2">
              <div className="text-center mb-8 animate-[slideDown_0.8s_ease-out]">
                ...
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-white leading-tight">
                  Clients <span className="text-pink-400">Promote You</span> for Free
                </h1>
                <p className="text-lg text-slate-400 mt-4">Instagram selfies, WhatsApp recommendations - word spreads fast</p>
              </div>
                ...
                <div className="bg-white/5 backdrop-blur-xl border-2 border-pink-500/30 rounded-3xl p-6">
                  <div className="flex flex-col md:flex-row items-center justify-center gap-4 text-center">
                    <div className="px-4 py-3 bg-white/5 rounded-xl border border-white/10 flex-1 max-w-[160px]">
                      <Scissors className="w-6 h-6 text-[#c9a227] mx-auto mb-2" />
                      <p className="text-white font-bold text-sm">Client Gets Service</p>
                    ...
                    <div className="px-4 py-3 bg-white/5 rounded-xl border border-white/10 flex-1 max-w-[160px]">
                      ...
                      <p className="text-white font-bold text-sm">Posts Selfie</p>
                      <p className="text-slate-400 text-xs">&ldquo;Love my new look!&rdquo;</p>
                    </div>
                    <ArrowRight className="text-pink-400 hidden md:block" size={20} />
                    <span className="text-pink-400 md:hidden">↓</span>
                    <div className="px-4 py-3 bg-white/5 rounded-xl border border-white/10 flex-1 max-w-[160px]">
                    ...
                    <div className="px-4 py-3 bg-pink-500/20 rounded-xl border-2 border-pink-500 flex-1 max-w-[160px]">
                      ...
                      <p className="text-pink-400 font-bold text-sm">New Clients!</p>
              ...
              <div className="grid grid-cols-3 gap-4 mb-6 animate-[fadeIn_0.8s_ease-out_0.3s] opacity-0 [animation-fill-mode:forwards]">
                <div className="bg-white/5 rounded-xl p-4 text-center border border-pink-500/20">
                  <p className="text-3xl font-black text-pink-400">27%</p>
                  <p className="text-slate-400 text-xs">New clients from referrals</p>
                </div>
                ...
                <div className="bg-white/5 rounded-xl p-4 text-center border border-emerald-500/20">
                  <p className="text-3xl font-black text-emerald-400">4.5x</p>
              ...
              <div className="animate-[slideUp_0.8s_ease-out_0.4s] opacity-0 [animation-fill-mode:forwards]">
                <div className="bg-pink-500/10 border border-pink-500/30 rounded-2xl p-5 text-center">
                  <p className="text-white">
                    <span className="text-pink-400 font-bold">Every transformation photo is free advertising.</span> When clients share their new look, their entire feed sees YOUR salon.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative z-10 max-w-6xl w-full px-2">
              <div className="text-center mb-8 animate-[slideDown_0.8s_ease-out]">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-cyan-500/20 border border-cyan-500/30 rounded-full mb-4">
                  ...
                  <span className="text-cyan-400 font-semibold text-sm">Free Salon OS</span>
                </div>
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-white leading-tight">
              ...
              <div className="mb-6 animate-[fadeIn_0.8s_ease-out_0.15s] opacity-0 [animation-fill-mode:forwards]">
                <div className="bg-gradient-to-r from-[#c9a227]/20 to-pink-500/20 border-2 border-[#c9a227]/50 rounded-2xl p-5">
                  <div className="flex flex-col sm:flex-row items-center gap-4">
                    ...
                    <div className="text-center sm:text-left">
                      ...
                      <p className="text-white">Clients earn <span className="text-[#c9a227] font-bold">&ldquo;[Your Salon] Coins&rdquo;</span> - not generic points. They see YOUR brand every time they check their balance, building loyalty to YOU.</p>
                    </div>
                    <div className="text-center flex-shrink-0">
                      <p className="text-3xl font-black text-emerald-400">+40%</p>
                      <p className="text-slate-400 text-xs">Higher rebooking rate</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6 animate-[fadeIn_0.8s_ease-out_0.2s] opacity-0 [animation-fill-mode:forwards]">
                {[
                  { icon: Users, title: 'Client Database', desc: 'Full CRM with preferences & history', color: 'cyan' },
                  { icon: Bell, title: 'Campaign Manager', desc: 'Send offers to your clients', color: 'pink' },
                  { icon: Target, title: 'Location Targeting', desc: 'Reach clients within 3km', color: 'emerald' },
                  { icon: Gift, title: 'Offer Creator', desc: 'Birthday deals, slow day specials', color: 'purple' },
                  { icon: BarChart3, title: 'Analytics', desc: 'Track bookings, peak hours', color: 'blue' },
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-4 mb-6 animate-[fadeIn_0.8s_ease-out_0.3s] opacity-0 [animation-fill-mode:forwards]">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-center">
                  {[
                    { type: 'Birthday', msg: '"Happy Birthday! Free blowdry"' },
                    { type: 'Win-Back', msg: '"Miss you! Bonus coins today"' },
                    { type: 'Slow Day', msg: '"Tuesday special: 3x coins"' },
                    { type: 'Rebooking', msg: '"Time for your next visit!"' }
                  ].map((c, idx) => (
          ...
          <div className={`${slideClass} w-full min-h-screen bg-gradient-to-br from-[#0a1628] via-[#1a2638] to-[#0a1628] flex items-center justify-center p-4 sm:p-6 md:p-12 relative overflow-hidden`}>
            ...
            <div className="relative z-10 max-w-5xl w-full px-2">
              ...
              <div className="space-y-4 animate-[fadeIn_0.8s_ease-out_0.2s] opacity-0 [animation-fill-mode:forwards]">
                {[
                  {
                    q: '"We already have regulars who love us"',
                    a: "Perfect! Your existing regulars aren't affected. This is about converting the 60% who visit once and never rebook. That's your growth opportunity.",
                    icon: Users
                  },
                  {
                    q: '"My services are premium - I don\'t want discount seekers"',
                    a: "Nuqta isn't about discounts. Clients pay YOUR full price. The coins are a thank-you bonus, not a price cut. Premium stays premium.",
                    icon: DollarSign
                  },
                  {
                    q: '"Clients forget to log their visits"',
                    a: "Clients get reminded when they have coins to spend - that's when they rebook! The app does the work, not you.",
                    icon: Smartphone
                  },
                  {
                    q: '"We use Fresha/Booksy - will this conflict?"',
                    a: "Nuqta works alongside any booking system. Clients pay you normally, then log the receipt. Your current operations don't change.",
                    icon: Gift
                  }
                ].map((item, idx) => (
          ...
          <div className={`${slideClass} w-full min-h-screen bg-gradient-to-br from-[#0a1628] via-[#1a2638] to-[#0a1628] flex items-center justify-center p-4 sm:p-6 md:p-12 relative overflow-hidden`}>
            ...
            <div className="relative z-10 max-w-6xl w-full px-2">
              <div className="text-center mb-8 animate-[slideDown_0.8s_ease-out]">
                ...
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-white leading-tight">
                  Salons <span className="text-[#c9a227]">Already Winning</span>
                </h1>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 mb-8 animate-[fadeIn_0.8s_ease-out_0.1s] opacity-0 [animation-fill-mode:forwards]">
                {[
                  { value: '2.5x', label: 'More Rebookings' },
                  { value: '+45%', label: 'Avg Spend Increase' },
                  { value: '91%', label: 'Coin Redemption Rate' }
                ].map((stat, idx) => (
                  <div key={idx} className="text-center p-4 bg-white/5 rounded-xl border border-white/10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-[fadeIn_0.8s_ease-out_0.2s] opacity-0 [animation-fill-mode:forwards]">
                {[
                  {
                    quote: "Clients who used to visit every 8 weeks now come every 4-5 weeks. They want to use their coins before they 'expire' in their minds.",
                    name: "Ladies Salon",
                    business: "Jumeirah, Dubai",
                    stat: "+85% rebookings",
                    verified: true
                  },
                  {
                    quote: "The dashboard shows me exactly which services my best clients prefer. I can now plan my schedule and promotions around real data.",
                    name: "Men's Barbershop",
                    business: "Marina, Dubai",
                    stat: "+52% revenue",
                    verified: true
                  }
                ].map((item, idx) => (
          ...
          <div className={`${slideClass} w-full min-h-screen bg-gradient-to-br from-[#0a1628] via-[#1a2638] to-[#0a1628] flex items-center justify-center p-4 sm:p-6 md:p-12 relative overflow-hidden`}>
            ...
            <div className="relative z-10 max-w-5xl w-full px-2">
              ...
              <div className="mb-6 animate-[fadeIn_0.8s_ease-out_0.1s] opacity-0 [animation-fill-mode:forwards]">
                <div className="bg-gradient-to-r from-red-500/20 to-pink-500/20 border-2 border-red-500/30 rounded-2xl p-4 text-center">
                  <p className="text-white font-bold">
                    <span className="text-red-400">Only 3 salon spots left</span> in your area this month
                  </p>
                ...
                {[
                  {
                    ...
                    desc: 'We limit salons per area. First to join gets priority over competitors.',
                    icon: Target
                  },
                  {
                    title: 'Founder Rates',
                  ...
                  },
                  {
                    ...
                    desc: 'Nuqta users are actively looking for new salons to earn coins.',
                    icon: Users
                  },
                  {
                    title: 'Zero Risk',
                ...
                {[
                  {
                    ...
                    desc: 'We never share your client list with competitors. Your data is your competitive advantage.',
                    icon: Shield
                  },
                  {
                  ...
                  },
                  {
                    ...
                    desc: 'See exactly which clients came through Nuqta. No hidden fees, no surprises.',
                    icon: BarChart3
                  },
                  {
          ...
          <div className={`${slideClass} w-full min-h-screen bg-gradient-to-br from-[#0a1628] via-[#1a2638] to-[#0a1628] flex items-center justify-center p-4 sm:p-6 md:p-12 relative overflow-hidden`}>
            ...
            <div className="relative z-10 max-w-4xl w-full text-center px-2">
              <div className="animate-[slideDown_0.8s_ease-out]">
                <Scissors className="w-16 h-16 text-[#c9a227] mx-auto mb-4" />
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-white leading-tight mb-6">
                  Ready to Fill Your Chairs<br />
                  <span className="bg-gradient-to-r from-[#c9a227] to-pink-400 bg-clip-text text-transparent">Every Day</span>?
                </h1>
              </div>

              <div className="relative mb-8 animate-[fadeIn_0.8s_ease-out_0.2s] opacity-0 [animation-fill-mode:forwards]">
                <div className="absolute inset-0 bg-gradient-to-r from-[#c9a227]/20 to-pink-500/20 rounded-3xl blur-xl" />
                <div className="relative bg-white/5 backdrop-blur-xl border-2 border-[#c9a227]/30 rounded-3xl p-8 sm:p-10">
                  ...
                  <div className="grid grid-cols-4 gap-2 mb-6 text-center">
                    {[
                      ...
                      { day: 'Day 7', action: 'First Rebookings!', icon: '✂️' }
                    ].map((step, idx) => (
                      <div key={idx} className="p-2 bg-white/5 rounded-lg">
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6">
                    <a href="mailto:merchants@nuqtapp.com?subject=Salon Partnership - Schedule Setup Call" className="flex items-center gap-2 px-6 py-3 bg-[#c9a227] text-[#0a1628] rounded-full font-bold hover:bg-[#d4b03f] transition-colors">
                      <Mail size={20} />
                      Schedule Setup Call
                    </a>
                  ...
                  <div className="flex flex-wrap gap-3 justify-center">
                    {['Zero upfront cost', '2.5x more rebookings', 'Cancel anytime'].map((item, idx) => (
