...
import { ChevronLeft, ChevronRight, TrendingUp, Zap, Target, Shield, Clock, DollarSign, ShoppingCart, Store, Search, CreditCard, CheckCircle, Coins, XCircle, RefreshCw, Timer } from 'lucide-react';
...
const PitchDeck90Second = () => {
  ...
  const renderSlide = () => {
    switch (currentSlide) {
      ...
      case 0:
        return (
          <div className="w-full min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-8 relative overflow-hidden">
            {/* Animated background */}
      ...
      case 1:
        return (
          <div className="w-full min-h-screen bg-gradient-to-br from-red-50 to-orange-50 flex items-center justify-center p-8">
      ...
      case 2:
        return (
          <div className="w-full min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 flex items-center justify-center p-8">
            <div className="max-w-6xl w-full">
              {/* Timer */}
              <div className="text-center mb-8">
      ...
      case 3:
        return (
          <div className="w-full min-h-screen bg-gradient-to-br from-emerald-50 to-teal-50 flex items-center justify-center p-8">
            <div className="max-w-6xl w-full">
              {/* Timer */}
              <div className="text-center mb-8">
      ...
      case 4:
        return (
          <div className="w-full min-h-screen bg-gradient-to-br from-slate-900 to-purple-900 flex items-center justify-center p-8">
            <div className="max-w-6xl w-full">
              {/* Timer */}
              <div className="text-center mb-8">
                <div className="inline-block bg-purple-100 border-2 border-purple-300 rounded-full px-4 py-2 mb-4">
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                ...
                <div className="bg-red-500/20 border-2 border-red-500/40 backdrop-blur-sm rounded-2xl p-8">
                  ...
                  <div className="mt-6 text-center">
                    <p className="text-red-400 font-bold text-xl">Discounts decay</p>
                  </div>
                </div>
                ...
                <div className="bg-emerald-500/20 border-2 border-emerald-500/40 backdrop-blur-sm rounded-2xl p-8">
                  ...
                  <div className="mt-6 text-center">
                    <p className="text-emerald-400 font-bold text-xl">Habits compound</p>
                  </div>
                </div>
              </div>
      ...
      case 5:
        return (
          <div className="w-full min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center p-8">
            <div className="max-w-6xl w-full">
              {/* Timer */}
              <div className="text-center mb-8">
      ...
      case 6:
        return (
          <div className="w-full min-h-screen bg-gradient-to-br from-purple-900 via-slate-900 to-purple-900 flex items-center justify-center p-8">
            <div className="max-w-6xl w-full">
              {/* Timer */}
              <div className="text-center mb-8">
              ...
              <div className="bg-gradient-to-r from-amber-500 to-orange-500 rounded-2xl p-8 mb-8">
                <div className="text-center">
                  ...
                  <div className="grid md:grid-cols-3 gap-6 mb-6">
                    <div>
                      <p className="text-5xl font-black text-white mb-2">$400K USD</p>
                      <p className="text-amber-100">SAFE Investment</p>
                    </div>
                    <div>
                      <p className="text-5xl font-black text-white mb-2">$5M USD</p>
      ...
      <div className="fixed bottom-8 left-1/2 transform -translate-x-1/2 z-50">
        <div className="bg-slate-900/90 backdrop-blur-md border border-slate-700 rounded-full px-6 py-3 flex items-center gap-4">
          <button
            ...
            className="p-2 rounded-full hover:bg-slate-700 disabled:opacity-30 disabled:cursor-not-allowed transition-all"
          >
...
export default PitchDeck90Second;
