...
const controls = [
  'BNPL product engine',
  'Merchant integration for installments',
  'Credit scoring & risk assessment',
  'Installment plan management',
  'Collection & recovery workflows',
  'Merchant settlement engine',
  'BNPL analytics & reporting',
  'Shariah-compliant financing structure',
];

const doesNotOwn = [
  { item: 'Payment processing', reason: 'Managed by NuqtaPay' },
  { item: 'Merchant onboarding', reason: 'Managed by BizOne' },
  ...
  { item: 'Property financing', reason: 'Managed by Sakin' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-emerald-500/5 rounded-xl p-6 border border-emerald-500/30">
            <h3 className="text-lg font-bold text-emerald-400 mb-4 flex items-center gap-2"><CheckCircle className="w-5 h-5" /> What Qist Controls</h3>
