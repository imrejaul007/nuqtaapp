...
const categories: Category[] = [
  // ─── 1. RTMN Core ──────────────────────────────────────────────
  {
    ...
    pages: [
      ...
      { title: 'Inter-Company Economics', href: '/inter-company-economics', description: 'How every company charges every other — commissions, SaaS, spreads', icon: DollarSign },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              { label: 'Inter-Company Economics', href: '/inter-company-economics', icon: DollarSign, color: 'bg-[#c9a227] text-[#0a1628]' },
