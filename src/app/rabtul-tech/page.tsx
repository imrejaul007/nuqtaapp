...
const sprintStructure = [
  ...
  {
    sprint: 9,
    name: 'Sakin + Ajer Complete + Safar Start',
    duration: '2 weeks',
    priority: '4️⃣ + 5️⃣ Fourth + Fifth Priority',
    claudeTasks: [
      { task: 'Sakin Landlord Portal', assignee: 'Sakin Squad', claudePrompt: 'Build landlord management portal - REUSES merchant portal base', status: 'todo' },
      { task: 'Sakin Short-stay Module', assignee: 'Sakin Squad', claudePrompt: 'Create Airbnb-style short-term rental booking engine', status: 'todo' },
      { task: 'Ajer Booking Flow', assignee: 'Ajer Squad', claudePrompt: 'Build vehicle reservation, pickup scheduling, deposit collection', status: 'todo' },
      { task: 'Ajer Fleet Portal', assignee: 'Ajer Squad', claudePrompt: 'Create fleet partner management portal - REUSES merchant portal base', status: 'todo' },
      { task: 'Safar GDS Integration', assignee: 'Safar Squad', claudePrompt: 'Integrate Amadeus/Sabre GDS for flight search, fare comparison', status: 'todo' },
      { task: 'Safar Hotel Aggregation', assignee: 'Safar Squad', claudePrompt: 'Build hotel search with multiple supplier integrations (Expedia, Booking)', status: 'todo' },
    ],
  },
  {
    sprint: 10,
    name: 'Safar OTA + Rakab Start',
    duration: '2 weeks',
    priority: '5️⃣ Fifth Priority',
    claudeTasks: [
      { task: 'Safar Booking Engine', assignee: 'Safar Squad', claudePrompt: 'Build unified booking flow for flights + hotels + packages with Qist BNPL split', status: 'todo' },
      { task: 'TravoPay Wallet', assignee: 'Safar Squad', claudePrompt: 'Create travel wallet with multi-currency support - REUSES Hawil FX engine', status: 'todo' },
      { task: 'Safar Nuqta Integration', assignee: 'Mobile Squad', claudePrompt: 'Add travel booking section in Nuqta consumer app with 3X coin earning', status: 'todo' },
      { task: 'Rakab Ride Request', assignee: 'Rakab Squad', claudePrompt: 'Build rider request flow: pickup/dropoff, fare estimate, matching algorithm', status: 'todo' },
      { task: 'Rakab Driver App', assignee: 'Rakab Squad', claudePrompt: 'Create driver app with go-online, navigation, earnings - REUSES Wasil Rider App (70%)', status: 'todo' },
      { task: 'Rakab Matching Algorithm', assignee: 'Rakab Squad', claudePrompt: 'Build nearest driver matching, surge pricing, demand heat maps', status: 'todo' },
    ],
  },
  {
    sprint: 11,
    name: 'Safar + Rakab Complete',
    duration: '2 weeks',
    priority: '5️⃣ Fifth Priority',
    claudeTasks: [
      { task: 'Safar Fakhir Concierge', assignee: 'Safar Squad', claudePrompt: 'Build premium concierge service for Nuqta Prive members - 24/7 white-glove travel', status: 'todo' },
      { task: 'Safar Adventure Apps', assignee: 'Safar Squad', claudePrompt: 'Create Weekendzy, BeachLife, DesertVibes experience booking modules', status: 'todo' },
      { task: 'Rakab Trip Management', assignee: 'Rakab Squad', claudePrompt: 'Build trip tracking, fare calculation, rating, receipt - REUSES Wasil tracking', status: 'todo' },
      { task: 'Rakab Business', assignee: 'Rakab Squad', claudePrompt: 'Create corporate ride accounts, expense management, monthly billing', status: 'todo' },
      { task: 'Rakab Airport Shuttle', assignee: 'Rakab Squad', claudePrompt: 'Build airport pickup/dropoff scheduling - integrates with Safar flight data', status: 'todo' },
      { task: 'All Phase 2 Integration', assignee: 'Platform Squad', claudePrompt: 'Ensure Safar + Rakab fully connected to NuqtaPay, coins, Qist, all services', status: 'todo' },
    ],
  },
  {
    sprint: 12,
    name: 'Discovery Apps + Adzy Start',
    duration: '2 weeks',
    priority: '6️⃣ Phase 3 — Intelligence',
    claudeTasks: [
      { task: 'AI-R Discovery Engine', assignee: 'Discovery Squad', claudePrompt: 'Build AI-first chat-based discovery with personalized recommendations (16 endpoints)', status: 'todo' },
      { task: 'BuzzLoop Social Feed', assignee: 'Discovery Squad', claudePrompt: 'Create social/UGC feed with creator tools, trending content (28 endpoints)', status: 'todo' },
      { task: 'CoinHunt Gamification', assignee: 'Discovery Squad', claudePrompt: 'Build gamified deals, flash deals, cross-ecosystem challenges (22 endpoints)', status: 'todo' },
      { task: 'LocalEdge Hyperlocal', assignee: 'Discovery Squad', claudePrompt: 'Create hyperlocal discovery with check-ins, mayorships, neighborhood recs (24 endpoints)', status: 'todo' },
      { task: 'Adzy Ad Platform Core', assignee: 'Adzy Squad', claudePrompt: 'Build ad inventory manager, campaign creation, targeting engine using ecosystem data', status: 'todo' },
      { task: 'Adzy Merchant Dashboard', assignee: 'Adzy Squad', claudePrompt: 'Create ad campaign management portal for merchants - REUSES merchant portal base', status: 'todo' },
    ],
  },
  {
    sprint: 13,
    name: 'Vertical Apps + Inventora + Eventora',
    duration: '2 weeks',
    priority: '6️⃣ Phase 3 — Verticals',
    claudeTasks: [
      { task: 'StyleSync Fashion', assignee: 'Vertical Squad', claudePrompt: 'Build virtual closet, AI outfit suggestions, fashion marketplace (18 endpoints)', status: 'todo' },
      { task: 'FitCircle Health', assignee: 'Vertical Squad', claudePrompt: 'Create fitness tracking, workouts, nutrition with Wasil supplement auto-order (25 endpoints)', status: 'todo' },
      { task: 'TechHunt Electronics', assignee: 'Vertical Squad', claudePrompt: 'Build price comparison, alerts, electronics marketplace (16 endpoints)', status: 'todo' },
      { task: 'HomeHub Home Services', assignee: 'Vertical Squad', claudePrompt: 'Create room planner, home services booking via Wasil OrderSDK (19 endpoints)', status: 'todo' },
      { task: 'Inventora Warehouse', assignee: 'Inventora Squad', claudePrompt: 'Build warehouse management with BizOne inventory sync, stock alerts, batch tracking', status: 'todo' },
      { task: 'Eventora Ticketing', assignee: 'Eventora Squad', claudePrompt: 'Create event discovery, ticketing, NuqtaPay checkout, QR entry', status: 'todo' },
    ],
  },
  {
    sprint: 14,
    name: 'Wasil Wave 2-3 + NextaBizz',
    duration: '2 weeks',
    priority: '6️⃣ Phase 3 — Scale',
    claudeTasks: [
      { task: 'Wasil Wave 2 Apps', assignee: 'Wasil Squad', claudePrompt: 'Build Shopazy, Funzy, AutoPerks, Petzy, Kidzo — all REUSE Wasil shared APIs (35 endpoints)', status: 'todo' },
      { task: 'Wasil Wave 3 Premium', assignee: 'Wasil Squad', claudePrompt: 'Create Luxora, Elitezy, Royale+ premium delivery tiers (22 endpoints)', status: 'todo' },
      { task: 'NextaBizz B2B Marketplace', assignee: 'NextaBizz Squad', claudePrompt: 'Build B2B bulk ordering, supplier management, Qist business credit', status: 'todo' },
      { task: 'Gigzy Freelancer Platform', assignee: 'NextaBizz Squad', claudePrompt: 'Create freelancer marketplace with NuqtaPay payments, skill matching', status: 'todo' },
      { task: 'Growth Stack Core', assignee: 'Growth Squad', claudePrompt: 'Build ReferralHub, LoyaltyMax, Contestify — viral growth tools for ecosystem', status: 'todo' },
    ],
  },
  {
    sprint: 15,
    name: 'Wasil Wave 4 + Full Integration',
    duration: '2 weeks',
    priority: '6️⃣ Phase 3 — Complete',
    claudeTasks: [
      { task: 'Wasil Wave 4 Apps', assignee: 'Wasil Squad', claudePrompt: 'Build remaining 9 Wasil apps: Washzy, Maidzy, Essentia+, Society+, Bizora, Gamezy, Wellnez, Learnly (65 endpoints)', status: 'todo' },
      { task: 'Adzy Full Network', assignee: 'Adzy Squad', claudePrompt: 'Connect ad inventory across all 60+ app surfaces, real-time bidding, analytics', status: 'todo' },
      { task: 'Cross-Ecosystem AI', assignee: 'AI/ML Squad', claudePrompt: 'Train recommendation models on all product data, build AI-R voice control across all services', status: 'todo' },
      { task: 'GCC Localization', assignee: 'Platform Squad', claudePrompt: 'Multi-region deployment: UAE, Saudi, Bahrain, Kuwait, Oman, Qatar — localization + compliance', status: 'todo' },
      { task: 'Super-App Unified Shell', assignee: 'Mobile Squad', claudePrompt: 'Unify all services into single Nuqta super-app with dynamic module loading', status: 'todo' },
    ],
  },
  {
    sprint: 16,
    ...
    duration: '2 weeks',
    priority: '7️⃣ Phase 4 — India',
    claudeTasks: [
      { task: 'India Compliance Layer', assignee: 'India Squad', claudePrompt: 'Build RBI-compliant payment aggregator, UPI integration, KYC with Aadhaar/PAN', status: 'todo' },
      { task: 'Hawil India Receiver', assignee: 'India Squad', claudePrompt: 'Create India payout: bank deposit via IMPS/NEFT/UPI, wallet credit, cash pickup', status: 'todo' },
      { task: 'NuqtaPay India', assignee: 'India Squad', claudePrompt: 'Build UPI-integrated wallet for India market with local payment methods', status: 'todo' },
      { task: 'BizOne India (Tier 2/3)', assignee: 'India Squad', claudePrompt: 'Localize BizOne POS for Indian SMEs — Hindi/regional languages, GST compliance', status: 'todo' },
      { task: 'India Data Residency', assignee: 'Platform Squad', claudePrompt: 'Deploy India-specific infra: Mumbai/Hyderabad data centers, RBI data localization', status: 'todo' },
    ],
  },
  {
    sprint: 17,
    name: 'Europe Market Entry',
    duration: '2 weeks',
    priority: '7️⃣ Phase 4 — Europe',
    claudeTasks: [
      { task: 'UK FCA Compliance', assignee: 'Europe Squad', claudePrompt: 'Build FCA-compliant EMI/payment institution platform, PSD2 open banking integration', status: 'todo' },
      { task: 'Hawil UK Remittance', assignee: 'Europe Squad', claudePrompt: 'Create UK→GCC, UK→India, UK→Africa remittance corridors with FCA compliance', status: 'todo' },
      { task: 'Qist UK BNPL', assignee: 'Europe Squad', claudePrompt: 'Build UK consumer credit compliant BNPL with FCA reporting, affordability checks', status: 'todo' },
      { task: 'GDPR Data Layer', assignee: 'Europe Squad', claudePrompt: 'Implement GDPR consent management, data portability, right to deletion across all services', status: 'todo' },
      { task: 'EU Passporting Prep', assignee: 'Europe Squad', claudePrompt: 'Prepare EMI license passporting from UK/Ireland to EU27 — multi-language, local compliance', status: 'todo' },
    ],
  },
  {
    sprint: 18,
    name: 'USA Market Entry',
    duration: '2 weeks',
    priority: '7️⃣ Phase 4 — USA',
    claudeTasks: [
      { task: 'US BaaS Integration', assignee: 'USA Squad', claudePrompt: 'Integrate with US Banking-as-a-Service (Stripe Treasury/Unit) to avoid 50-state MTL', status: 'todo' },
      { task: 'NuqtaPay US', assignee: 'USA Squad', claudePrompt: 'Build US wallet with ACH, debit card, Visa/MC issuance via partner bank', status: 'todo' },
      { task: 'Qist US BNPL', assignee: 'USA Squad', claudePrompt: 'Create US-compliant BNPL via lending partner, state-by-state rollout (CA, NY, TX, FL first)', status: 'todo' },
      { task: 'Hawil US Corridors', assignee: 'USA Squad', claudePrompt: 'Build US→GCC, US→India remittance via licensed MTL partner, FinCEN BSA compliance', status: 'todo' },
      { task: 'US Localization', assignee: 'USA Squad', claudePrompt: 'Adapt Nuqta app for US market — USD, local merchants, US app store optimization', status: 'todo' },
    ],
  },
];
...
const engineeringSquads = [
  ...
  // ═══════════════════════════════════════════════════════════════════
  // PHASE 3: Discovery, Adzy, Vertical, Wasil Wave 2-4, Inventora, NextaBizz, Eventora
  // ═══════════════════════════════════════════════════════════════════
  {
    id: 'discovery-apps',
    name: '6️⃣ Discovery Apps Squad',
    phase: 3,
    priority: 'P2',
    priorityOrder: 6,
    headcount: { current: 0, target: 10 },
    lead: 'Senior Full-stack Engineer',
    description: 'AI-R, BuzzLoop, CoinHunt, LocalEdge — intelligence layer on top of ecosystem data',
    techStack: ['React Native', 'Node.js', 'PostgreSQL', 'Redis', 'ML Models'],
    color: 'from-indigo-500 to-purple-600',
    textColor: 'text-indigo-400',
    bgColor: 'bg-indigo-500/10',
    borderColor: 'border-indigo-500',
    members: [
      { role: 'Senior Full-stack Engineer', count: 2, priority: 'P2' },
      { role: 'Backend Engineer', count: 3, priority: 'P2' },
      { role: 'Mobile Engineer', count: 3, priority: 'P2' },
      { role: 'ML Engineer', count: 1, priority: 'P2' },
      { role: 'QA Engineer', count: 1, priority: 'P2' },
    ],
    deliverables: [
      { name: 'AI-R Chat Discovery', priority: 'P2', sprint: 12, status: 'todo', description: 'AI-first discovery with chat - 16 endpoints, 6 pages' },
      { name: 'BuzzLoop Social Feed', priority: 'P2', sprint: 12, status: 'todo', description: 'UGC feed, creator tools, trending - 28 endpoints' },
      { name: 'CoinHunt Challenges', priority: 'P2', sprint: 12, status: 'todo', description: 'Gamified deals, flash deals, cross-ecosystem challenges - 22 endpoints' },
      { name: 'LocalEdge Check-ins', priority: 'P2', sprint: 12, status: 'todo', description: 'Hyperlocal check-ins, mayorships - 24 endpoints' },
      { name: 'Shared Discovery SDK', priority: 'P2', sprint: 12, status: 'todo', description: 'SSO + Coin Ledger + Notifications + AIRA shared layer' },
    ],
  },
  {
    id: 'vertical-apps',
    name: '6️⃣ Vertical Apps Squad',
    phase: 3,
    priority: 'P2',
    priorityOrder: 6,
    headcount: { current: 0, target: 8 },
    lead: 'Senior Full-stack Engineer',
    description: 'StyleSync, FitCircle, TechHunt, HomeHub — vertical expansion apps',
    ...
    borderColor: 'border-teal-500',
    members: [
      { role: 'Senior Full-stack Engineer', count: 1, priority: 'P2' },
      { role: 'Backend Engineer', count: 3, priority: 'P2' },
      { role: 'Mobile Engineer', count: 2, priority: 'P2' },
      { role: 'QA Engineer', count: 1, priority: 'P2' },
      { role: 'UI Designer', count: 1, priority: 'P2' },
    ],
    deliverables: [
      { name: 'StyleSync Fashion', priority: 'P2', sprint: 13, status: 'todo', description: 'Virtual closet, AI outfits - 18 endpoints' },
      { name: 'FitCircle Health', priority: 'P2', sprint: 13, status: 'todo', description: 'Fitness, nutrition, Wasil auto-order - 25 endpoints' },
      { name: 'TechHunt Electronics', priority: 'P2', sprint: 13, status: 'todo', description: 'Price comparison, alerts - 16 endpoints' },
      { name: 'HomeHub Services', priority: 'P2', sprint: 13, status: 'todo', description: 'Home services, room planner - 19 endpoints' },
    ],
  },
  {
    id: 'adzy-ads',
    name: '6️⃣ Adzy Ad Platform Squad',
    phase: 3,
    priority: 'P2',
    priorityOrder: 6,
    headcount: { current: 0, target: 10 },
    lead: 'Senior Backend Engineer',
    description: 'Cross-ecosystem ad network — every app surface = ad inventory',
    techStack: ['Go', 'PostgreSQL', 'Redis', 'Kafka', 'ML Models'],
    ...
    members: [
      { role: 'Senior Backend Engineer', count: 2, priority: 'P2' },
      { role: 'Backend Engineer', count: 3, priority: 'P2' },
      { role: 'ML Engineer (Ad Targeting)', count: 2, priority: 'P2' },
      { role: 'Frontend Engineer', count: 2, priority: 'P2' },
      { role: 'QA Engineer', count: 1, priority: 'P2' },
    ],
    deliverables: [
      { name: 'Ad Inventory Manager', priority: 'P2', sprint: 12, status: 'todo', description: 'Map all app surfaces as ad placements' },
      { name: 'Campaign Engine', priority: 'P2', sprint: 12, status: 'todo', description: 'Create, target, schedule ad campaigns' },
      { name: 'Targeting Engine', priority: 'P2', sprint: 13, status: 'todo', description: 'ML-based targeting using ecosystem behavior data' },
      { name: 'Merchant Ad Dashboard', priority: 'P2', sprint: 13, status: 'todo', description: 'Self-serve ad creation - REUSES merchant portal base' },
      { name: 'Real-time Bidding', priority: 'P2', sprint: 15, status: 'todo', description: 'RTB for premium placements, auction system' },
      { name: 'Ad Analytics', priority: 'P2', sprint: 15, status: 'todo', description: 'Impressions, clicks, conversions, ROAS tracking' },
    ],
  },
  {
    id: 'inventora-warehouse',
    name: '6️⃣ Inventora Squad',
    phase: 3,
    priority: 'P2',
    priorityOrder: 6,
    headcount: { current: 0, target: 6 },
    lead: 'Senior Backend Engineer',
    description: 'Warehouse management — syncs with BizOne inventory, powers Wasil fulfillment',
    techStack: ['Node.js', 'PostgreSQL', 'Redis', 'Barcode/RFID'],
    color: 'from-amber-500 to-yellow-600',
    textColor: 'text-amber-400',
    bgColor: 'bg-amber-500/10',
    borderColor: 'border-amber-500',
    members: [
      { role: 'Senior Backend Engineer', count: 1, priority: 'P2' },
      { role: 'Backend Engineer', count: 2, priority: 'P2' },
      { role: 'Frontend Engineer', count: 2, priority: 'P2' },
      { role: 'QA Engineer', count: 1, priority: 'P2' },
    ],
    deliverables: [
      { name: 'Warehouse Management Core', priority: 'P2', sprint: 13, status: 'todo', description: 'Stock in/out, bin locations, batch tracking' },
      { name: 'BizOne Inventory Sync', priority: 'P2', sprint: 13, status: 'todo', description: 'Real-time sync with BizOne POS inventory' },
      { name: 'Wasil Fulfillment', priority: 'P2', sprint: 14, status: 'todo', description: 'Pick, pack, ship integration with Wasil delivery' },
      { name: 'Multi-warehouse Support', priority: 'P2', sprint: 14, status: 'todo', description: 'Multiple locations, transfer orders' },
    ],
  },
  {
    id: 'nextabizz-b2b',
    name: '6️⃣ NextaBizz B2B Squad',
    phase: 3,
    priority: 'P2',
    priorityOrder: 6,
    headcount: { current: 0, target: 8 },
    lead: 'Senior Full-stack Engineer',
    description: 'B2B marketplace + Gigzy freelancer platform — business-to-business commerce',
    techStack: ['Node.js', 'React', 'PostgreSQL', 'Kafka'],
    color: 'from-blue-500 to-indigo-600',
    textColor: 'text-blue-400',
    bgColor: 'bg-blue-500/10',
    borderColor: 'border-blue-500',
    ...
    deliverables: [
      { name: 'B2B Marketplace Core', priority: 'P2', sprint: 14, status: 'todo', description: 'Supplier catalog, bulk ordering, RFQ' },
      { name: 'Qist Business Credit', priority: 'P2', sprint: 14, status: 'todo', description: 'B2B credit - REUSES Qist credit scoring (90%)' },
      { name: 'Gigzy Freelancer Platform', priority: 'P2', sprint: 14, status: 'todo', description: 'Freelancer marketplace, skill matching, NuqtaPay payments' },
      { name: 'Supplier Portal', priority: 'P2', sprint: 15, status: 'todo', description: 'Supplier management - REUSES merchant portal base' },
    ],
  },
  {
    id: 'eventora-events',
    name: '6️⃣ Eventora Squad',
    phase: 3,
    priority: 'P2',
    priorityOrder: 6,
    headcount: { current: 0, target: 6 },
    lead: 'Senior Full-stack Engineer',
    description: 'Event ticketing, community events, Z-Events — integrated with NuqtaPay + Rakab',
    techStack: ['Node.js', 'React Native', 'PostgreSQL', 'Stripe'],
    ...
    deliverables: [
      { name: 'Event Discovery', priority: 'P2', sprint: 13, status: 'todo', description: 'Browse, filter, recommend events' },
      { name: 'Ticketing Engine', priority: 'P2', sprint: 13, status: 'todo', description: 'Purchase, QR entry, seat selection, NuqtaPay checkout' },
      { name: 'Event Management Portal', priority: 'P2', sprint: 14, status: 'todo', description: 'Organizer tools - REUSES merchant portal base' },
      { name: 'Rakab Event Transport', priority: 'P2', sprint: 14, status: 'todo', description: 'Auto-suggest Rakab rides to/from events' },
    ],
  },
  {
    id: 'wasil-wave2-4',
    name: '6️⃣ Wasil Wave 2-4 Squad',
    phase: 3,
    priority: 'P2',
    priorityOrder: 6,
    headcount: { current: 0, target: 12 },
    lead: 'Senior Backend Engineer',
    description: '17 additional Wasil delivery apps — 80%+ code reuse from Wave 1',
    techStack: ['Go', 'PostgreSQL', 'Redis', 'React Native'],
    ...
    deliverables: [
      { name: 'Wave 2: 5 Apps', priority: 'P2', sprint: 14, status: 'todo', description: 'Shopazy, Funzy, AutoPerks, Petzy, Kidzo - 35 endpoints, 80% reuse' },
      { name: 'Wave 3: Premium Tier', priority: 'P2', sprint: 14, status: 'todo', description: 'Luxora, Elitezy, Royale+ - 22 endpoints, premium delivery' },
      { name: 'Wave 4: 9 Apps', priority: 'P2', sprint: 15, status: 'todo', description: 'Washzy, Maidzy, Essentia+, Society+, Bizora, Gamezy, Wellnez, Learnly - 65 endpoints' },
      { name: 'Shared Wasil API Updates', priority: 'P2', sprint: 15, status: 'todo', description: 'Update shared cart, checkout, tracking APIs for 22 total verticals' },
    ],
  },
  // ═══════════════════════════════════════════════════════════════════
  // PHASE 4: Global Expansion — India, Europe, USA
  // ═══════════════════════════════════════════════════════════════════
  {
    id: 'india-expansion',
    name: '7️⃣ India Expansion Squad',
    phase: 4,
    priority: 'P3',
    priorityOrder: 7,
    headcount: { current: 0, target: 25 },
    lead: 'India Country Head (Engineering)',
    description: 'India market entry — Hawil corridor, NuqtaPay with UPI, BizOne for Tier 2/3 SMEs, Qist BNPL',
    techStack: ['Node.js', 'React Native', 'PostgreSQL', 'UPI/IMPS', 'Aadhaar APIs'],
    color: 'from-orange-500 to-green-600',
    textColor: 'text-orange-400',
    bgColor: 'bg-orange-500/10',
    borderColor: 'border-orange-500',
    members: [
      { role: 'India Country Head (Eng)', count: 1, priority: 'P3' },
      { role: 'Senior Backend Engineer', count: 4, priority: 'P3' },
      { role: 'Backend Engineer', count: 8, priority: 'P3' },
      { role: 'Mobile Engineer', count: 4, priority: 'P3' },
      { role: 'Frontend Engineer', count: 3, priority: 'P3' },
      { role: 'Compliance Engineer', count: 2, priority: 'P3' },
      { role: 'QA Engineer', count: 2, priority: 'P3' },
      { role: 'DevOps Engineer', count: 1, priority: 'P3' },
    ],
    deliverables: [
      { name: 'RBI Compliance Layer', priority: 'P3', sprint: 16, status: 'todo', description: 'Payment aggregator compliance, data localization, KYC with Aadhaar/PAN' },
      { name: 'UPI Integration', priority: 'P3', sprint: 16, status: 'todo', description: 'NuqtaPay India with UPI collect, pay, autopay' },
      { name: 'Hawil India Payout', priority: 'P3', sprint: 16, status: 'todo', description: 'UAE→India receiver: IMPS, NEFT, UPI credit, wallet' },
      { name: 'BizOne India Localization', priority: 'P3', sprint: 17, status: 'todo', description: 'Hindi + regional languages, GST billing, Indian POS' },
      { name: 'Qist India BNPL', priority: 'P3', sprint: 17, status: 'todo', description: 'NBFC-compliant BNPL for India market' },
      { name: 'Nuqta India Consumer App', priority: 'P3', sprint: 18, status: 'todo', description: 'Localized app: INR, local merchants, India App Store' },
      { name: 'India Data Center', priority: 'P3', sprint: 16, status: 'todo', description: 'Mumbai + Hyderabad deployment, RBI data residency' },
    ],
  },
  {
    id: 'europe-expansion',
    name: '7️⃣ Europe Expansion Squad',
    phase: 4,
    priority: 'P3',
    priorityOrder: 7,
    headcount: { current: 0, target: 20 },
    lead: 'Europe Country Head (Engineering)',
    description: 'UK-first entry → EU passporting — Hawil remittance, Qist BNPL, NuqtaPay wallet',
    techStack: ['Node.js', 'React Native', 'PostgreSQL', 'Open Banking APIs', 'PSD2'],
    color: 'from-blue-500 to-cyan-600',
    textColor: 'text-blue-400',
    bgColor: 'bg-blue-500/10',
    borderColor: 'border-blue-500',
    members: [
      { role: 'Europe Country Head (Eng)', count: 1, priority: 'P3' },
      { role: 'Senior Backend Engineer', count: 3, priority: 'P3' },
      { role: 'Backend Engineer', count: 6, priority: 'P3' },
      { role: 'Mobile Engineer', count: 3, priority: 'P3' },
      { role: 'Frontend Engineer', count: 2, priority: 'P3' },
      { role: 'Compliance Engineer (FCA/EU)', count: 2, priority: 'P3' },
      { role: 'QA Engineer', count: 2, priority: 'P3' },
      { role: 'DevOps Engineer', count: 1, priority: 'P3' },
    ],
    deliverables: [
      { name: 'FCA EMI Platform', priority: 'P3', sprint: 17, status: 'todo', description: 'UK e-money institution compliance, KYC, AML' },
      { name: 'PSD2 Open Banking', priority: 'P3', sprint: 17, status: 'todo', description: 'Account aggregation, payment initiation via Open Banking' },
      { name: 'Hawil UK Corridors', priority: 'P3', sprint: 17, status: 'todo', description: 'UK→GCC, UK→India, UK→Africa remittance' },
      { name: 'Qist UK BNPL', priority: 'P3', sprint: 18, status: 'todo', description: 'FCA consumer credit BNPL, affordability checks' },
      { name: 'GDPR Compliance Layer', priority: 'P3', sprint: 17, status: 'todo', description: 'Consent management, data portability, right to deletion' },
      { name: 'EU EMI Passporting', priority: 'P3', sprint: 19, status: 'todo', description: 'Passport UK EMI license to EU27: DE, FR, NL, ES' },
      { name: 'Multi-language Support', priority: 'P3', sprint: 18, status: 'todo', description: 'English, German, French, Spanish, Dutch localization' },
      { name: 'EU Data Center', priority: 'P3', sprint: 17, status: 'todo', description: 'Frankfurt + Dublin deployment, GDPR data residency' },
    ],
  },
  {
    id: 'usa-expansion',
    name: '7️⃣ USA Expansion Squad',
    phase: 4,
    priority: 'P3',
    priorityOrder: 7,
    headcount: { current: 0, target: 20 },
    lead: 'USA Country Head (Engineering)',
    description: 'US market via BaaS partner model — NuqtaPay, Qist BNPL, Hawil corridors',
    techStack: ['Node.js', 'React Native', 'PostgreSQL', 'Plaid', 'Stripe Treasury'],
    color: 'from-red-500 to-blue-600',
    textColor: 'text-red-400',
    bgColor: 'bg-red-500/10',
    borderColor: 'border-red-500',
    members: [
      { role: 'USA Country Head (Eng)', count: 1, priority: 'P3' },
      { role: 'Senior Backend Engineer', count: 3, priority: 'P3' },
      { role: 'Backend Engineer', count: 6, priority: 'P3' },
      { role: 'Mobile Engineer', count: 3, priority: 'P3' },
      { role: 'Frontend Engineer', count: 2, priority: 'P3' },
      { role: 'Compliance Engineer (US)', count: 2, priority: 'P3' },
      { role: 'QA Engineer', count: 2, priority: 'P3' },
      { role: 'DevOps Engineer', count: 1, priority: 'P3' },
    ],
    deliverables: [
      { name: 'US BaaS Integration', priority: 'P3', sprint: 18, status: 'todo', description: 'Stripe Treasury or Unit for banking, avoid 50-state MTL' },
      { name: 'NuqtaPay US Wallet', priority: 'P3', sprint: 18, status: 'todo', description: 'USD wallet, ACH transfers, debit card via partner bank' },
      { name: 'Qist US BNPL', priority: 'P3', sprint: 19, status: 'todo', description: 'US BNPL via lending partner: CA, NY, TX, FL first' },
      { name: 'Hawil US Corridors', priority: 'P3', sprint: 18, status: 'todo', description: 'US→GCC, US→India via licensed MTL partner, FinCEN BSA' },
      { name: 'FinCEN BSA Compliance', priority: 'P3', sprint: 18, status: 'todo', description: 'MSB registration, BSA/AML program, SAR reporting' },
      { name: 'BizOne US (Immigrant SMEs)', priority: 'P3', sprint: 19, status: 'todo', description: 'Localized POS for immigrant-owned businesses: restaurants, grocery, retail' },
      { name: 'US App Store Launch', priority: 'P3', sprint: 19, status: 'todo', description: 'Nuqta US launch: English, USD, local merchant discovery' },
      { name: 'US Data Center', priority: 'P3', sprint: 18, status: 'todo', description: 'US-East + US-West deployment, SOC 2 compliance' },
    ],
  },
  // ═══════════════════════════════════════════════════════════════════
...
const developmentPhases = [
  ...
  },
  {
    ...
    focus: 'Safar Travel OTA, Rakab Ride-Hailing — highest ARPU products',
    squads: ['travel-safar', 'rakab-mobility'],
    headcount: 200,
    milestones: [
      { month: 10, milestone: 'Safar GDS integration + hotel aggregation starts' },
      { month: 11, milestone: 'Safar booking engine live + TravoPay wallet (REUSES Hawil FX)' },
      { month: 11, milestone: 'Rakab driver app + matching algorithm (REUSES Wasil 70%)' },
      { month: 12, milestone: 'Safar Fakhir luxury concierge for Nuqta Prive members' },
      { month: 12, milestone: 'Rakab trip management + airport shuttle (integrates Safar)' },
      { month: 13, milestone: 'Adventure apps: Weekendzy, BeachLife, DesertVibes live' },
      { month: 14, milestone: '✅ Safar + Rakab fully live — 41 total apps, 1.5M+ users' },
    ],
  ...
  {
    phase: 3,
    name: 'Scale, Intelligence & Monetization',
    timeline: 'Month 12-20',
    focus: 'Discovery Apps, Adzy Ads, Vertical Apps, Wasil Wave 2-4, Inventora, NextaBizz, Eventora, GCC expansion',
    squads: ['discovery-apps', 'vertical-apps', 'adzy-ads', 'inventora-warehouse', 'nextabizz-b2b', 'eventora-events', 'wasil-wave2-4'],
    headcount: 350,
    milestones: [
      { month: 12, milestone: 'AI-R + BuzzLoop + CoinHunt + LocalEdge discovery layer live' },
      { month: 13, milestone: 'Adzy ad platform + targeting engine using ecosystem data' },
      { month: 13, milestone: 'StyleSync + FitCircle + TechHunt + HomeHub vertical apps' },
      { month: 13, milestone: 'Inventora warehouse + Eventora ticketing live' },
      { month: 14, milestone: 'Wasil Wave 2 (5 apps) + Wave 3 premium tier + NextaBizz B2B' },
      { month: 15, milestone: 'Wasil Wave 4 (9 apps) + Adzy full ad network across 60+ surfaces' },
      { month: 15, milestone: 'Gigzy freelancer platform + Growth Stack (ReferralHub, Contestify)' },
      { month: 16, milestone: 'GCC localization: Saudi Arabia, Bahrain, Kuwait, Oman, Qatar' },
      { month: 18, milestone: 'Cross-ecosystem AI-R voice control across all services' },
      { month: 20, milestone: '✅ 100+ apps live across 10 companies, full GCC coverage' },
    ],
  ...
  },
  {
    ...
    focus: 'India (corridor play) → UK/Europe (fintech wedge) → USA (BaaS partner model)',
    squads: ['india-expansion', 'europe-expansion', 'usa-expansion'],
    headcount: 450,
    milestones: [
      { month: 18, milestone: 'India: Hawil receiver live (UAE→India payout via UPI/IMPS)' },
      { month: 19, milestone: 'India: NuqtaPay India wallet with UPI + BizOne Tier 2/3 cities' },
      { month: 20, milestone: 'India: Qist India BNPL via NBFC partnership' },
      { month: 20, milestone: 'Europe: UK FCA sandbox application + Hawil UK corridors' },
      { month: 22, milestone: 'Europe: Qist UK BNPL live + NuqtaPay UK wallet' },
      { month: 22, milestone: 'USA: BaaS integration + NuqtaPay US wallet (Stripe Treasury)' },
      { month: 24, milestone: 'USA: Qist US BNPL (CA, NY, TX, FL) + Hawil US corridors' },
      { month: 24, milestone: 'Europe: EU EMI passporting → Germany, France, Netherlands' },
      { month: 26, milestone: 'India: Full Nuqta ecosystem live (delivery, travel, rewards)' },
      { month: 28, milestone: 'USA: BizOne US for immigrant SMEs + Nuqta US consumer launch' },
      { month: 30, milestone: '✅ Live in 10+ countries — GCC, India, UK, DE, FR, US' },
    ],
    color: 'border-emerald-500 bg-emerald-500/10',
    textColor: 'text-emerald-400',
  },
...
const priorityConfig = {
  ...
  'P3': { label: 'Low', color: 'bg-slate-500 text-white', description: 'Global expansion' },
  'P4': { label: 'Future', color: 'bg-gray-600 text-white', description: 'Long-term roadmap' },
};
