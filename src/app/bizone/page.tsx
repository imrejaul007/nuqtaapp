...
import {
  ...
  Hash, Percent, Box, Repeat, Share2, Landmark, Banknote, PiggyBank, GanttChart
} from 'lucide-react';
...
const bizOneSuite = [
  ...
  },
  {
    ...
    name: 'BizOne Finance',
    arabic: 'المحاسبة',
    tagline: 'Accounting, VAT & Financial Management',
    description: 'Full double-entry accounting auto-populated from POS sales. FTA-compliant VAT filing, P&L, balance sheet — zero manual entry.',
    icon: Landmark,
    status: 'Q4 2027',
    ...
    features: [
      { name: 'Auto Accounting', description: 'Every POS sale auto-creates journal entries — zero double-entry', icon: Calculator },
      { name: 'VAT Management', description: 'Auto-calculate 5% VAT, generate FTA-compliant returns, one-click filing', icon: Receipt },
      { name: 'P&L Dashboard', description: 'Real-time profit & loss, balance sheet, cash flow statements', icon: BarChart3 },
      { name: 'Expense Tracking', description: 'Photograph receipts, auto-categorize, track business expenses', icon: CreditCard },
      { name: 'Bank Reconciliation', description: 'Auto-match bank transactions with POS records', icon: CheckCircle },
      { name: 'Financial Reports', description: 'Investor-ready reports, audit trail, multi-year comparisons', icon: FileText },
    ],
    pricing: [
      { tier: 'Basic', price: 'Included', features: ['Auto from POS', 'Basic P&L', 'VAT calculation'] },
      { tier: 'Pro', price: '199 AED/mo', features: ['Full accounting', 'VAT filing', 'Bank reconciliation', 'Multi-entity'] },
      { tier: 'Enterprise', price: '499 AED/mo', features: ['All features', 'Audit trail', 'Accountant access', 'Custom reports'] },
    ],
  },
  {
    id: 'payroll',
    name: 'BizOne Payroll',
    arabic: 'الرواتب',
    tagline: 'Payroll & WPS Compliance',
    description: 'UAE WPS-compliant payroll — salary disbursement, leave management, end-of-service calculation, all from BizOne.',
    icon: Banknote,
    status: 'Q1 2028',
    ...
    features: [
      { name: 'WPS File Generation', description: 'Generate SIF files for Wages Protection System — all banks supported', icon: FileText },
      { name: 'Salary Structure', description: 'Basic + housing + transport + allowances — UAE labor law compliant', icon: Calculator },
      { name: 'Leave Management', description: 'Annual, sick, maternity, unpaid — auto-calculate balance and deductions', icon: CalendarDays },
      { name: 'End of Service', description: 'Auto-calculate gratuity based on UAE labor law (21/30 days per year)', icon: Award },
      { name: 'Employee Portal', description: 'Staff view payslips, request leave, update documents — self-service', icon: Users },
      { name: 'Khedma Integration', description: 'Link to Khedma for visa processing, labor cards, and MOHRE compliance', icon: Shield },
    ],
    pricing: [
      { tier: 'Small', price: '149 AED/mo', features: ['Up to 10 employees', 'WPS files', 'Basic leave tracking'] },
      { tier: 'Medium', price: '349 AED/mo', features: ['Up to 50 employees', 'Full HR suite', 'Employee portal'] },
      { tier: 'Large', price: '699 AED/mo', features: ['Unlimited', 'Multi-branch', 'API integration', 'Dedicated support'] },
    ],
  },
  {
    id: 'lending',
    name: 'BizOne Capital',
    arabic: 'التمويل',
    tagline: 'Merchant Lending & Working Capital',
    description: 'Pre-approved working capital based on your BizOne transaction history. Apply in 2 minutes, funded in 24 hours, repay from daily sales.',
    icon: PiggyBank,
    status: 'Q1 2028',
    ...
    features: [
      { name: 'Instant Pre-approval', description: 'AI scores your BizOne sales history — see your limit in seconds', icon: Zap },
      { name: 'Daily Auto-repay', description: 'Small % deducted from daily sales — no lump sum payments, no stress', icon: Repeat },
      { name: 'Flexible Amounts', description: '5,000 - 500,000 AED based on monthly sales volume', icon: DollarSign },
      { name: 'No Collateral', description: 'Your transaction history IS the collateral — no property or guarantees needed', icon: Shield },
      { name: 'Growth Dashboard', description: 'Track how capital deployed → revenue generated → ROI achieved', icon: TrendingUp },
      { name: 'Shariah-compliant', description: 'Murabaha-based financing structure — transparent cost, no hidden fees', icon: Star },
    ],
    pricing: [
      { tier: 'Micro', price: '5K-50K AED', features: ['6-month term', 'Daily repay from sales', '8-12% flat fee'] },
      { tier: 'Growth', price: '50K-200K AED', features: ['12-month term', 'Flexible repayment', '6-10% flat fee'] },
      { tier: 'Scale', price: '200K-500K AED', features: ['18-month term', 'Custom structure', 'Dedicated advisor'] },
    ],
  },
  {
    id: 'storefront',
    name: 'BizOne Storefront',
    arabic: 'المتجر',
    tagline: 'Branded Online Store Builder',
    description: 'Build your branded online store in minutes. Customers browse your store, you manage everything from BizOne. Like Shopify, inside the ecosystem.',
    icon: GanttChart,
    status: 'Q2 2028',
    ...
    features: [
      { name: 'Drag-and-Drop Builder', description: 'Pick a template, add your products, go live in minutes — no coding', icon: Monitor },
      { name: 'Custom Domain', description: 'yourstore.bizone.ae or your own domain — SSL included', icon: Globe },
      { name: 'Nuqta Checkout', description: 'NuqtaPay, Qist BNPL, cards, cash on delivery — all built in', icon: ShoppingCart },
      { name: 'Wasil Delivery', description: 'Orders auto-route to Wasil fleet — no logistics headaches', icon: Truck },
      { name: 'Product Catalog', description: 'Sync from Inventora — stock levels auto-update, out-of-stock auto-hide', icon: Package },
      { name: 'SEO & Social', description: 'Built-in SEO, social sharing, Google Shopping integration', icon: Share2 },
    ],
    pricing: [
      { tier: 'Starter', price: '99 AED/mo', features: ['50 products', 'Basic template', 'NuqtaPay checkout'] },
      { tier: 'Business', price: '299 AED/mo', features: ['Unlimited products', 'Custom domain', 'All payment methods', 'Analytics'] },
      { tier: 'Premium', price: '599 AED/mo', features: ['Everything', 'Priority placement', 'Marketing tools', 'API access'] },
    ],
  },
];
