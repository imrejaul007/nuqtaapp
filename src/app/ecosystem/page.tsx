...
const userJourneys = [
  {
    persona: 'Ahmed - Expat from Pakistan',
    icon: Briefcase,
    ...
    steps: [
      ...
      { product: 'Hawil', action: 'Sends 5K/month to family', savings: '3,600 AED/year vs banks' },
    ],
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <div className="flex justify-center mb-8">
              <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[#c9a227] to-amber-600 flex items-center justify-center shadow-2xl shadow-[#c9a227]/30 border-4 border-[#c9a227]/50">
                <div className="text-center">
                  <Crown className="w-8 h-8 text-white mx-auto" />
                  <span className="text-white text-xs font-bold">NUQTA</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 md:grid-cols-6 gap-4">
              {coreProducts.map((product, i) => (
                ...
                >
                  <div className={`w-10 h-10 rounded-lg bg-gradient-to-br ${product.color} flex items-center justify-center mx-auto mb-2`}>
