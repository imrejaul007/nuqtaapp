...
export const metadata: Metadata = {
  ...
  description: "Earn universal rewards on everyday spending and always know the smartest way to pay. Nuqta connects payments, rewards, and loyalty into one intelligent system for UAE & GCC.",
