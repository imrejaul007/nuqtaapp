      ...
      <div className="min-h-screen bg-[#0a1628] text-white overflow-x-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center relative z-10 2xl:pr-80">
            ...
            <AnimatedSection delay={200}>
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-bold mb-4 sm:mb-6 leading-tight">
                <span className="gradient-text animate-shimmer">Rewards-Led</span> Commerce Intelligence
              </h1>
            </AnimatedSection>
            ...
            <AnimatedSection delay={400}>
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-400 max-w-xs sm:max-w-xl md:max-w-2xl lg:max-w-3xl mx-auto mb-6 sm:mb-8 md:mb-10 px-2">
                Save <span className="text-[#c9a227] font-bold">5-10%</span> on everyday offline spending — <span className="text-white font-semibold">cafes, salons, gyms</span> — with instant cashback
              </p>
            </AnimatedSection>
        ...
        <section className="section-padding bg-[#0d1c30]">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8 text-center">
              {[
                { value: 30, suffix: '', prefix: '', label: 'Signed Merchant LOIs', displayValue: '30' },
                { value: 4.1, suffix: 'M', prefix: 'AED ', label: 'Addressable GMV', displayValue: 'AED 4.1M' },
                { value: 16.8, suffix: 'x', prefix: '', label: 'LTV:CAC Ratio', displayValue: '16.8x' },
                { value: 7, suffix: ' Days', prefix: '', label: 'To Launch', displayValue: '7 Days' },
              ].map((stat, idx) => (
                <AnimatedSection key={idx} delay={idx * 150}>
                  <div className="group cursor-pointer">
                    <p className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#c9a227] group-hover:scale-110 transition-transform">
                      {stat.displayValue || <AnimatedCounter end={stat.value} prefix={stat.prefix} suffix={stat.suffix} />}
                    </p>
        ...
        <section className="section-padding bg-[#0d1c30]">
          <div className="max-w-6xl mx-auto">
            <AnimatedSection>
              <div className="text-center mb-12">
                <span className="inline-block px-4 py-2 bg-[#c9a227]/10 border border-[#c9a227]/30 rounded-full mb-4">
                  <span className="text-[#c9a227] text-sm font-medium">Unit Economics</span>
                </span>
                <h2 className="text-3xl md:text-4xl font-bold">Built for Profitability</h2>
                <p className="text-gray-400 mt-2 max-w-2xl mx-auto">
                  Strong unit economics from day one with a proven path to scale
                </p>
              </div>
            </AnimatedSection>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <AnimatedSection delay={100}>
                <div className="bg-gradient-to-br from-[#1a2a42] to-[#0a1628] rounded-2xl p-6 border-2 border-[#c9a227]/30 hover:border-[#c9a227]/60 transition-all hover:scale-105 duration-300">
                  <div className="flex items-center gap-3 mb-4">
                    <span className="text-3xl">💰</span>
                    <h3 className="text-xl font-bold text-[#c9a227]">CAC</h3>
                  </div>
                  <p className="text-4xl font-bold text-white mb-4">AED 30</p>
                  <div className="space-y-2 text-sm text-gray-400">
                    <div className="flex justify-between">
                      <span>Merchant QR</span>
                      <span className="text-white font-medium">AED 10-15</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Ambassadors</span>
                      <span className="text-white font-medium">AED 25-30</span>
                    </div>
                  </div>
                </div>
              </AnimatedSection>
              ...
              <AnimatedSection delay={200}>
                <div className="bg-gradient-to-br from-[#1a2a42] to-[#0a1628] rounded-2xl p-6 border-2 border-[#c9a227]/30 hover:border-[#c9a227]/60 transition-all hover:scale-105 duration-300">
                  <div className="flex items-center gap-3 mb-4">
                    <span className="text-3xl">📈</span>
                    <h3 className="text-xl font-bold text-[#c9a227]">LTV</h3>
                  </div>
                  <p className="text-4xl font-bold text-white mb-4">AED 504</p>
                  <div className="space-y-2 text-sm text-gray-400">
                    <div className="flex justify-between">
                      <span>Monthly RPU</span>
                      <span className="text-white font-medium">AED 42</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Retention</span>
              ...
              <AnimatedSection delay={300}>
                <div className="bg-gradient-to-br from-[#c9a227] to-[#f4d35e] rounded-2xl p-6 border-2 border-[#c9a227] hover:border-[#f4d35e] transition-all hover:scale-105 duration-300">
                  <div className="flex items-center gap-3 mb-4">
                    <span className="text-3xl">🚀</span>
                    <h3 className="text-xl font-bold text-[#0a1628]">LTV:CAC</h3>
                  </div>
                  <p className="text-4xl font-bold text-[#0a1628] mb-4">16.8x</p>
                  <div className="space-y-2 text-sm text-[#0a1628]/70">
                    <div className="flex justify-between">
                      <span>Payback Period</span>
                      <span className="text-[#0a1628] font-medium">&lt;1 month</span>
                    </div>
                    <div className="pt-2 border-t border-[#0a1628]/20">
                      <span className="text-[#0a1628] font-semibold">Industry benchmark: 3-5x</span>
                    </div>
                  </div>
                </div>
              </AnimatedSection>
