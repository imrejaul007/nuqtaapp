...
const launchChecklist: ChecklistCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'm9', task: 'First 10 Merchant Pipeline', status: 'pending', owner: 'Sales', priority: 'critical', notes: 'Build pipeline of target merchants' },
      { id: 'm10', task: 'Pilot Merchants Signed (Minimum 5)', status: 'pending', owner: 'Sales', priority: 'critical', blockedBy: 'App ready for demo' },
      { id: 'm11', task: 'QR Standees & Marketing Materials', status: 'pending', owner: 'Operations', priority: 'high', notes: 'Design ready, need to print' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'mk5', task: 'Content Calendar (Launch Month)', status: 'pending', owner: 'Marketing', priority: 'high' },
      { id: 'mk6', task: 'Launch Campaign Creative', status: 'pending', owner: 'Marketing', priority: 'high' },
      { id: 'mk7', task: 'Influencer Partnership List', status: 'pending', owner: 'Marketing', priority: 'medium' },
      { id: 'mk8', task: 'PR Launch Plan', status: 'pending', owner: 'Marketing', priority: 'medium' },
      { id: 'mk9', task: 'App Store Screenshots & Description', status: 'pending', owner: 'Marketing', priority: 'high', blockedBy: 'App finalized' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'o4', task: 'Support Response Templates', status: 'pending', owner: 'Operations', priority: 'medium' },
